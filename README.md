...
I specialize in:
- Defining product vision and North Star metrics
- Owning end-to-end product lifecycle (0 → 1 → Scale)
- Driving cross-functional alignment across Engineering, Design, Sales & Leadership
- Building high-performance Agile teams
- Delivering data-driven product decisions

---

## 🎯 Product Leadership Philosophy

- Customer-first thinking, outcome-driven execution  
- Strong product discovery before delivery  
- Metrics-led prioritization (Revenue, Adoption, Retention)  
- Clarity in roadmap, conviction in execution  
...
Roadmapping | OKRs | North Star Metrics | Portfolio Prioritization

**Execution Excellence**
Agile Leadership | Scrum | Stakeholder Management | Cross-functional Alignment

**Technical Depth**
APIs | Cloud Architecture | SaaS Platforms | Data Analytics | AI Integrations

**Business Impact**
Revenue Growth | Cost Optimization | Adoption & Retention | Enterprise Negotiations

---

## 🛠 Tools & Ecosystem

Jira | Confluence | Figma | Miro | ADO | Power BI | API Services | Product Analytics

---

## 🎓 Education

Executive PGDBM – Indian Institute of Management Kashipur  
...
LinkedIn: [https://www.linkedin.com/in/nandan-mishra-5b81a182/]  
Email: [nandanmishra93@hotmail.com]

---

> “Great products are not built by managing backlogs — they are built by leading vision, aligning teams, and driving outcomes.”
